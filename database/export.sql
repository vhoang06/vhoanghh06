...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_method` enum('cod','bank') COLLATE utf8mb4_general_ci DEFAULT 'cod',
...
-- Dumping data for table office_supplies.products: ~7 rows (approximately)
...
INSERT INTO `products` (`id`, `name`, `category_id`, `brand_id`, `price`, `description`, `image`, `stock`) VALUES
	...
	(3, 'Bàn học chống cận thông minh', 1, 4, 2500000.00, 'Bàn học có thể điều chỉnh độ cao, mặt bàn nghiêng giúp bé ngồi học đúng tư thế, bảo vệ mắt và cột sống.', 'assets/images/products/prod_69d06461b03d5.jpg', 15),
...
-- Dumping data for table office_supplies.users: ~2 rows (approximately)
DELETE FROM `users`;
